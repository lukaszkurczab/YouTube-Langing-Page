    ...
    <Wrapper>
      <div className="main__listWrapper">
        <div className="main__list">
          <Button text="Add to queue" desc="Add to queue" icon="./images/queue.svg" link="#" />
          <Button text="Save to Watch Later" desc="Save" icon="./images/time.svg" link="#" />
          <Button text="Save to playlist" desc="Save to playlist" icon="./images/saveOnList.svg" link="#" />
        </div>
        <div className="main__list">
